  ...
  return (
    <div className="w-full bg-white shadow-sm rounded-[10px] p-4 pt-8">
      <div className="flex items-center cursor-pointer w-full mb-8" onClick={() => setActive(1)}>
        ...
        <span className={`pl-3 ${active === 1 ? 'text-[red]' : null} 800px:block hidden`}>
          Profile
        </span>
      </div>
      ...
      <div className="flex items-center cursor-pointer w-full mb-8" onClick={() => setActive(2)}>
        ...
        <span className={`pl-3 ${active === 2 ? 'text-[red]' : null} 800px:block hidden`}>
          Orders
        </span>
      </div>
      ...
      <div className="flex items-center cursor-pointer w-full mb-8" onClick={() => setActive(3)}>
        ...
        <span className={`pl-3 ${active === 3 ? 'text-[red]' : null} 800px:block hidden`}>
          Refunds
        </span>
      </div>
      ...
      >
        ...
        <span className={`pl-3 ${active === 4 ? 'text-[red]' : null} 800px:block hidden`}>
          Inbox
        </span>
      </div>
      ...
      <div className="flex items-center cursor-pointer w-full mb-8" onClick={() => setActive(5)}>
        ...
        <span className={`pl-3 ${active === 5 ? 'text-[red]' : null} 800px:block hidden`}>
          Track Order
        </span>
      </div>
      ...
      <div className="flex items-center cursor-pointer w-full mb-8" onClick={() => setActive(6)}>
        ...
        <span className={`pl-3 ${active === 6 ? 'text-[red]' : null} 800px:block hidden`}>
          Change Password
        </span>
      </div>
      ...
      >
        ...
        <span className={`pl-3 ${active === 8 ? 'text-[red]' : null} 800px:block hidden`}>
          Log out
        </span>
      </div>
    </div>
