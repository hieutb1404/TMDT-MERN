    ...
    <div className={`py-4 min-h-screen ${styles.section}`}>
      <div className="w-full flex items-center justify-between">
        <div className="flex items-center">
          ...
          <h1 className="pl-2 text-[25px]">OrderDetails</h1>
        </div>
      ...
      {/* neu khac vs status Processing refund thi co quyen select status other */}
          ...
          {[
            ...
            .slice(
              [
                ...
                'On the way',
                'Delivered',
              ].indexOf(data?.status), // su dung  indexOf de cat bot mang tu vi tri co gi tri trung voi gia tri trung voi data?.status. Nghia la moi gia tri chi chon duoc 1 lan va se bi xoa di
            )
            .map((option, index) => (
      ...
      <div
        ...
        // select cua order va refund xu ly rieng
        onClick={
