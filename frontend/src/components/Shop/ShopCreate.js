...
function ShopCreate() {
  ...
  const handleSubmit = async (e) => {
    ...
    // thang post se gui du lieu dong goi nay len server backend de xu ly.
    axios
      // trong app.js  backend router la gi thi o day la nhu vay, o day la shop thi la shop, la user thi la user
      ...
      .then((res) => {
        ...
        // sau khi tao thanh cong thi tat ca reset ve rong~ ""
        setName('');
        setEmail('');
        setPassword('');
        setAvatar();
